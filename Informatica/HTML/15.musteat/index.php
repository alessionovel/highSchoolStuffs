            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    for (i = 0; i < imp.UpdateList.length; i++) {
                        ...
                        var image = {
                            url: 'https://www.voltahosting.it/5E/mustEatNovel/images/punt.png',
                        ...
                        marker = new google.maps.Marker({
                            ...
                            optimized: false,
                            zIndex: 100,
                            title: imp.UpdateList[i].nome,
                            icon: image,
                            url: "https://www.voltahosting.it/5E/mustEatNovel/homeRist.php?idRist=" + imp.UpdateList[i].id
                        });
...
<body>
    <div id="header">
        <p class="header">MustEat</p>
    </div>
    <div id="dvMap" style="height: 45em; width: 100%;" class="map"></div>
